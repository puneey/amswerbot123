...
def update_data():
    ...
    file4 = open('data/num4.txt', 'w')
    file5 = open('data/gamerunning.txt', 'w')

    file1.write(str(data.counter1))
    file2.write(str(data.counter2))
    file3.write(str(data.counter3))
    file4.write(str(data.counter4))
    file5.write(str(int(data.game_in_session)))
...
async def on_message(message):
    ...
    if message.content.startswith('-j') and message.channel.id == data.command_channel:
    ...
    if data.game_in_session and message.channel.id in data.input_hq_private:
        ...
        elif message.content == '4' or message.content == '4apg' or message.content == '4 apg':
            data.counter_private_4 += 10
        elif message.content == '4?' or message.content == '?4':
            data.counter_private_4 += 5
        elif message.content == 'cnf4' or message.content == '4cnf' or message.content == '4 cnf':
            data.counter_private_4 += 15
    ...
    if data.game_in_session and message.channel.id in data.input_hq_public:
        if message.content == '1' or message.content == '1apg' or message.content == '1 apg':
            ...
            data.counter_public_4 += 10
        elif message.content == '4?' or message.content == '?4':
            data.counter_public_4 += 5
        elif message.content == '4q' or message.content == 'q4':
            data.counter_public_4 += 100
        elif message.content == '4x' or message.content == 'x4':
            data.wronggone3 = 1
        elif message.content == 'cnf4' or message.content == '3cnf' or message.content == '4 cnf':
            data.counter_public_4 += 15
    ...
    data.counter4 = data.weight_time * (data.counter_public_4 + data.weight * data.counter_private_4)
